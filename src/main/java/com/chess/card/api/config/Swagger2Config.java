...
public class Swagger2Config implements WebMvcConfigurer {
    ...
    public Docket defaultApi2() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .select()
                //此包路径下的类，才生成接口文档
                .apis(RequestHandlerSelectors.basePackage("com.chess.card.api.controller"))
...
//				.termsOfServiceUrl("NO terms of service")
                ...
                .description("后台API接口")
                // 作者
                .contact(new Contact("德州补克科技有限公司","https://www.chess.card.cn/","chess.card@163.cn"))
