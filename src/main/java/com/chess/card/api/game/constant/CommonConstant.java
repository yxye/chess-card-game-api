package com.chess.ws.api.game.constant;
...
public interface CommonConstant {
    ...
    /**访问权限认证未通过 510*/
    Integer SC_SANYUAN_NO_AUTHZ=510;

    /** 登录用户Shiro权限缓存KEY前缀 */
    public static String PREFIX_USER_SHIRO_CACHE  = "shiro:cache:org.sanyuan.config.shiro.ShiroRealm.authorizationCache:";
    /** 登录用户Token令牌缓存KEY前缀 */
...
//    int  TOKEN_EXPIRE_TIME  = 3600;
    ...
    */
    ...
    /**
     * ::非常重要::
     * 注意：这四个常量值如果修改，需要与 yxye-starter/yxye-common/org.sanyuan.config.FeignConfig 类中的值保持一致。
     */
    String X_ACCESS_TOKEN = "token";


    String USER_ACCESS_TOKEN = "token";
